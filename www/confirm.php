...
if(!isset($_POST['First_Name']) AND !isset($_POST['Password'])){ // Kolla om man har fyllt i namn OCH lösenord via formuläret
...
// Hämtar Användarnamn via kolumn First_Name som då används som användarnamn
...
if($row){ // Om användarnamnet i databasen är samma som i formuläret
